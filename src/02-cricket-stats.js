...
export const getPlayerCard = (player) => {
  if (player == null || player == undefined || player.name == null || player.name == undefined) {
    return null
  }
  ...
  const isAR = isAllRounder(battingAvg, economy)

  return { name, strikeRate, economy, battingAvg, isAllRounder: isAR }
};
